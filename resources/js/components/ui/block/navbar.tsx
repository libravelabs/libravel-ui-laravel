    ...
    return (
        <Comp className="w-full" {...props}>
            <Button
                tone="ghost"
                iconOnly={open}
                className={cn('relative w-full justify-start p-2')}
            >
...
const navbarContentVariants = cva(
    'relative flex min-h-0 max-w-full flex-1 flex-col bg-background',
    {
        variants: {
            variant: {
                default: '',
                float: '',
                inset: 'm-2 overflow-x-hidden overflow-y-auto rounded-xl shadow-sm',
            },
            placement: {
                top: '',
                bottom: '',
